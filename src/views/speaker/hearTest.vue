  ...
  <el-container>
    <el-aside>
      ...
      <div style="margin-left: 10px; width: 920px; height: 335px; padding: 0 6px; display: flex;">
        ...
        <div style="width: 18%; margin-left: 10px">
          ...
          <p v-if="prevRouter !== '/imitate'" style="font-size: 14px">当前正在答 {{ answerIndex && answerIndex <= 0
            ? '' : answerIndex + 1 }} 题</p>
        </div>
      </div>
      ...
      <el-row :gutter="10"
        style="margin-left: 10px; width: 920px; height: 305px; background-color: #efefef;padding-top: 6px;overflow: auto;">
        <el-col v-for="(item, index) in props.imageData.answerList" :key="item.id" :span="8">
    ...
    <el-main>
      ...
      <el-row class="el-btn a">
        ...
        <el-button v-if="prevRouter !== '/imitate'" :disabled="answerIndex + 1 !== answerMarks.length && !isStop"
      ...
      <el-row class="el-btn b">
        <el-button :disabled="!props.isPlay || isDisabled || enableManualplavMode || answerIndex <= 0"
        ...
        <el-button v-if="prevRouter !== '/imitate'"
          :disabled="!props.isPlay || isDisabled || enableManualplavMode || !isStop" @click="handleStop">测试结束</el-button>
      </el-row>
      <el-row>
