    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-row class="el-btn a">
          ...
          <el-button :disabled="!props.isPlay" size="large" plain  disabled>保存</el-button>
          <el-button :disabled="!props.isPlay"  size="large" plain disabled>提前结束</el-button>
        </el-row>
        <el-row class="el-btn b">
          <el-button :disabled="!props.isPlay" @click="handlePrev" disabled>上一个(左键)</el-button
          ><el-button :disabled="!props.isPlay" @click="handleNext" disabled>下一个(右键)</el-button
          ><el-button :disabled="!props.isPlay" @click="handleReImage" disabled>重复</el-button>
        </el-row>
        <el-row>
